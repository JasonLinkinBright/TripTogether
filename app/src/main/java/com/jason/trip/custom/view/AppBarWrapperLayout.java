...
public class AppBarWrapperLayout extends LinearLayout {
    ...
    protected void onFinishInflate() {
        ...
        mAppbarView = getChildAt(0); // toolBar
        mShadowCompatView = getChildAt(1); // tabLayout
    }
    ...
    public void hide() {
        ...
        // the whole animation is done above
        // the following part add some additional trick
