...
import com.jason.trip.custom.view.object.RObject;
...
public class TopicEditText extends EditText {
    ...
    public TopicEditText(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,
                R.styleable.TopicEditText);
        mBackgroundColor = a
                .getColor(R.styleable.TopicEditText_object_background_color, BACKGROUND_COLOR);
        mForegroundColor = a
                .getColor(R.styleable.TopicEditText_object_foreground_color, FOREGROUND_COLOR);
        a.recycle();
