...
package com.jason.trip.profile;
...
import com.jason.trip.network.api.User;
...
//    private static final String KEY_PREFIX = ProfileFragment.class.getName() + '.';
    ...
    private static final String KEY_PREFIX ="keyi"+'.';
...
//            ApiContract.Request.ApiV2.UserInfo userInfo = intent.getParcelableExtra(EXTRA_USER_INFO);
