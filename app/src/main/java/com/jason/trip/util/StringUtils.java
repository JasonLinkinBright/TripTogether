...
public class StringUtils {
    ...
    public static String formatAmount(String s) {
        return formatAmount(s, "#,###.00", false);
    }
     ...
     * @return 格式后的金额(###,###.##)
     */
    public static String formatAmount(String s, String format) {
        return formatAmount(s, format, false);
    }
     ...
     * @return 格式后的金额(###,###.##)
     */
    public static String formatAmount(String s, String format, boolean isInitNull) {
        String result = "";
        if (!isNotEmpty(s)) {
            return "";
        }
